...
{
    public abstract class E_TicketerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static E_TicketerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(E_TicketerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<E_TicketerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<E_TicketerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<E_TicketerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<E_TicketerDbContext, Task<T>> func)
        {
            T result;
